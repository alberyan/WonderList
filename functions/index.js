...
const gcconfig = {
    projectId: 'flutter-easylist-e6ef6',
    keyFilename: 'flutter-adminSDK.json'
};
...
var serviceAccount = require("./flutter-adminSDK.json");

admin.initializeApp({
    credential: admin.credential.cert(serviceAccount),
    databaseURL: "https://flutter-easylist-e6ef6.firebaseio.com"
});
...
exports.storeImage = functions.https.onRequest((req, res) => {
    return cors(req, res, () => {
        ...
        busboy.on('finish', () => {
            const bucket = gcs.bucket('flutter-easylist-e6ef6.appspot.com');
            const id = uuid();
